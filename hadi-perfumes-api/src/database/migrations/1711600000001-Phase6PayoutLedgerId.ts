...
export class Phase6PayoutLedgerId1711600000001 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "payout_requests" ADD "ledger_entry_id" uuid`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "payout_requests" DROP CONSTRAINT "FK_payout_requests_ledger_entry"`);
    await queryRunner.query(`ALTER TABLE "payout_requests" DROP COLUMN "ledger_entry_id"`);
  }
}
