...
@Module({
  imports: [
    TypeOrmModule.forFeature([
      TrustAuditLog,
      ReturnRequest, ReturnItem, ReturnEvidence, ReturnStatusHistory,
      Dispute, DisputeEvidence, DisputeStatusHistory,
      FraudSignal, RiskAssessment, AbuseWatchlistEntry,
      ModerationAction,
      PayoutHold, CommissionHold, ResolutionEvent,
